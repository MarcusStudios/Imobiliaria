...
export const PriceCard = ({ imovel }: PriceCardProps) => {
  const linkZap = `${WHATSAPP_URL}?text=Olá Lidiany! Vi o imóvel ${imovel.titulo.toUpperCase()} (Cód: ${imovel.id?.slice(0, 6).toUpperCase()}) e gostaria de mais informações.`;
    ...
    <div className="price-card">
      ...
      <div style={{ display: "grid", gap: "1rem" }}>
        <a
          ...
          aria-label={`Chamar no WhatsApp sobre o imóvel: ${imovel.titulo}`}
        >
